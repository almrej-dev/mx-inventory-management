...
import { getProduct, getProductBom } from "@/actions/products";
import { BomPreview } from "@/components/products/bom-preview";
...
export default async function ProductDetailPage({
  ...
  const [product, bomResult] = await Promise.all([
    getProduct(itemId),
    getProductBom(itemId),
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          All leaf-level raw materials and packaging items across all levels,
          with computed costs.
        </p>
        {bomResult.error ? (
